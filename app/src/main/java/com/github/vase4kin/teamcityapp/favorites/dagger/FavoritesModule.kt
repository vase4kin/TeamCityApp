...
class FavoritesModule {
    ...
    @Provides
    fun providesNavigationView(activity: FavoritesActivity,
                               adapter: SimpleSectionedRecyclerViewAdapter<NavigationAdapter>): FavoritesView {
        return FavoritesViewImpl(activity.findViewById<View>(android.R.id.content), activity, R.string.empty_list_message_favorites, adapter)
    }

    @Provides
    fun providesNavigationRouter(activity: FavoritesActivity): NavigationRouter {

...
class AgentsTabDrawerModule {

    @Provides
    fun providesDrawerView(activity: AgentTabsActivity): DrawerView {
        return DrawerViewImpl(activity, DrawerView.AGENTS, true)
    }

    @Provides
    fun providesDrawerRouter(activity: AgentTabsActivity): DrawerRouter {

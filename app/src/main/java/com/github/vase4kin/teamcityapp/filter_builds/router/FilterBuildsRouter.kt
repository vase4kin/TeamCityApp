...
/**
 * Router to manage [com.github.vase4kin.teamcityapp.filter_builds.view.FilterBuildsActivity] navigation
 */
interface FilterBuildsRouter {
     ...
     */
    fun closeOnSuccess(filter: BuildListFilter)

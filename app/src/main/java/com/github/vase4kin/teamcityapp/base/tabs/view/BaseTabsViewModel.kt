...
/**
 * Base view for activity with tabs
 */
interface BaseTabsViewModel {
     ...
     *
     * @param fragmentAdapter - Adapter to add fragments in it
     */
    fun addFragments(fragmentAdapter: FragmentAdapter)

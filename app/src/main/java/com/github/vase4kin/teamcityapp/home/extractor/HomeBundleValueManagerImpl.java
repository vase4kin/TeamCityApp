...
/**
 * Impl of {@link HomeBundleValueManager}
 */
public class HomeBundleValueManagerImpl extends BaseValueExtractorImpl implements HomeBundleValueManager {

    public HomeBundleValueManagerImpl(@NonNull Bundle mBundle) {
        super(mBundle);
    }

 ...
 */
public class AccountViewHolderFactory implements ViewHolderFactory<AccountDataModel> {

    /**
     * {@inheritDoc}
     */
    @Override
    public BaseViewHolder<AccountDataModel> createViewHolder(ViewGroup parent) {

...
/**
 * Tracker fabric impl of {@link BuildListTracker}
 */
public class FabricBuildListTrackerImpl implements BuildListTracker {
     ...
     */
    public FabricBuildListTrackerImpl(String contentName) {
        this.mScreenName = contentName;
    }

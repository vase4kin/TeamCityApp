...
/**
 * Impl of {@link HomeDataManager}
 */
public class HomeDataManagerImpl extends DrawerDataManagerImpl implements HomeDataManager {

    private final Context mContext;
    private final RxCache mRxCache;

    public HomeDataManagerImpl(Context context,

 ...
 */
public class FirebaseHomeTrackerImpl extends BaseFirebaseTracker implements HomeTracker {

    public FirebaseHomeTrackerImpl(FirebaseAnalytics firebaseAnalytics) {
    ...
    public void trackView() {
        firebaseAnalytics.logEvent(SCREEN_NAME_HOME, null);
    }

...
open class FirebaseBuildListTrackerImpl(
     ...
     * {@inheritDoc}
     */
    override fun trackRunBuildButtonPressed() {
        firebaseAnalytics.logEvent(BuildListTracker.EVENT_RUN_BUILD_BUTTON_PRESSED, null)
    }
    ...
    override fun trackUserWantsToSeeQueuedBuildDetails() {
        firebaseAnalytics.logEvent(BuildListTracker.EVENT_SHOW_QUEUED_BUILD_DETAILS, null)
    }
}

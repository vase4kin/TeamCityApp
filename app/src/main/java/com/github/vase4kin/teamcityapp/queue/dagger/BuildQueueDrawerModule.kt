...
class BuildQueueDrawerModule {

    @Provides
    fun providesDrawerView(activity: BuildQueueActivity): DrawerView {
        return DrawerViewImpl(activity, DrawerView.BUILD_QUEUE, true)
    }

    @Provides
    fun providesDrawerRouter(activity: BuildQueueActivity): DrawerRouter {

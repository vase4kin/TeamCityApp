...
class RunningBuildsModule {
    ...
    @Provides
    fun providesRunningBuildListView(activity: RunningBuildsListActivity,
                                     adapter: SimpleSectionedRecyclerViewAdapter<BuildListAdapter>): RunningBuildListView {
        return RunningBuildsListViewImpl(activity.findViewById(android.R.id.content), activity, R.string.empty_list_message_running_builds, adapter)
    }

    @Provides
    fun providesBuildListRouter(activity: RunningBuildsListActivity): BuildListRouter {

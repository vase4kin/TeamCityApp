...
/**
 * Tracker fabric impl of {@link FilterBuildsTracker}
 */
public class FabricFilterBuildsTrackerImpl implements FilterBuildsTracker {
    ...
    public void trackView() {
        ...
        Answers.getInstance().logContentView(new ContentViewEvent()
                .putContentName(SCREEN_NAME_FILTER_BUILDS));
    }
}

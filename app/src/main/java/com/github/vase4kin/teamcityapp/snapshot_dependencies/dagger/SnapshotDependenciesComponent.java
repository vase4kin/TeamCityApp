...
@PresenterScope
@Component(dependencies = RestApiComponent.class, modules = {SnapshotDependenciesModule.class, BuildListAdapterModule.class})
public interface SnapshotDependenciesComponent {

    void inject(SnapshotDependenciesFragment fragment);
}

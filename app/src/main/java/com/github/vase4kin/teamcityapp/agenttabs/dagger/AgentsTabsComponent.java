...
@PresenterScope
@Component(dependencies = RestApiComponent.class, modules = {AgentsTabsModule.class, DrawerModule.class})
public interface AgentsTabsComponent {

    void inject(AgentTabsActivity agentTabsActivity);
}
